...
configure<MixinExtension> {
    add(sourceSets["main"], "mixins.nano.refmap.json")
}
        ...
        create("client") {
            ...
            properties(
                mapOf(
                    ...
                    "fml.coreMods.load" to "dev.supermic.nanosense.NanoSenseCoreMod",
...
tasks {
    ...
    val releaseJar = register<Jar>("releaseJar") {
        ...
        manifest {
            attributes(
                ...
                "MixinConfigs" to "mixins.nano.core.json, mixins.nano.accessor.json, mixins.nano.patch.json",
                "TweakClass" to "org.spongepowered.asm.launch.MixinTweaker",
                "FMLCorePluginContainsFMLMod" to true,
                "FMLCorePlugin" to "dev.supermic.nanosense.NanoSenseCoreMod",
    ...
    configure<JarOptimizerPluginExtension> {
        add(releaseJar, "dev.supermic", "baritone", "org.spongepowered")
    }
    ...
    register<Task>("genRuns") {
        ...
        doLast {
            ...
            val vmOptions = listOf(
                ...
                "-Dfml.coreMods.load=dev.supermic.nanosense.NanoSenseCoreMod"
            ).joinToString(" ")
