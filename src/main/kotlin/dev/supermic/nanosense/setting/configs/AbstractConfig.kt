...
import dev.supermic.nanosense.setting.groups.SettingGroup
import dev.supermic.nanosense.setting.groups.SettingMultiGroup
...
abstract class AbstractConfig<T : Any>(
    ...
    override fun load() {
        ...
        try {
            ...
            NanoSenseMod.logger.warn("Failed to load latest, loading backup.")
