...
import dev.supermic.nanosense.gui.rgui.windows.ColorPicker
...
import dev.supermic.nanosense.util.accessor.listShaders
...
import dev.supermic.nanosense.util.graphics.shaders.ParticleShader
...
abstract class AbstractNanoGui<S : SettingWindow<*>, E : Any> : GuiScreen(), IListenerOwner by ListenerOwner() {
