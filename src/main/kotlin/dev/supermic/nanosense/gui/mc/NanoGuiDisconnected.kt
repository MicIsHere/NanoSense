package dev.supermic.nanosense.gui.mc

import kotlinx.coroutines.delay
import kotlinx.coroutines.launch
import dev.supermic.nanosense.module.modules.combat.AutoLog
import dev.supermic.nanosense.util.threads.mainScope
import net.minecraft.client.gui.GuiButton
import net.minecraft.client.gui.GuiScreen
import java.time.LocalTime

class NanoGuiDisconnected(private val reason: Array<String>, private val screen: GuiScreen, private val disable: Boolean, private val logoutTime: LocalTime) : GuiScreen() {
