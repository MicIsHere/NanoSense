...
import dev.supermic.nanosense.gui.rgui.InteractiveComponent
...
open class ListWindow(
    ...
    var hoveredChild: Component? = null
        private set(value) {
            ...
            (field as? InteractiveComponent)?.onLeave(AbstractNanoGui.getRealMousePos())
            (value as? InteractiveComponent)?.onHover(AbstractNanoGui.getRealMousePos())
            field = value
        }
