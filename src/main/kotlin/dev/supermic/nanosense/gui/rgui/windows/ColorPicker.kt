...
import dev.supermic.nanosense.gui.rgui.component.Button
import dev.supermic.nanosense.gui.rgui.component.SettingSlider
import dev.supermic.nanosense.gui.rgui.component.Slider
import dev.supermic.nanosense.module.modules.client.GuiSetting
import dev.supermic.nanosense.setting.GuiConfig.setting
import dev.supermic.nanosense.setting.settings.impl.other.ColorSetting
import dev.supermic.nanosense.util.graphics.*
import dev.supermic.nanosense.util.graphics.color.ColorRGB
import dev.supermic.nanosense.util.graphics.color.ColorUtils
...
object ColorPicker : TitledWindow("Color Picker", 0.0f, 0.0f, 200.0f, 200.0f, SettingGroup.NONE) {
    ...
    private var hoveredChild: Slider? = null
        set(value) {
            ...
            field?.onLeave(AbstractNanoGui.getRealMousePos())
            value?.onHover(AbstractNanoGui.getRealMousePos())
            field = value
        }
