...
import dev.supermic.nanosense.event.events.combat.CombatEvent
...
import dev.supermic.nanosense.module.modules.combat.CombatSetting
...
import dev.supermic.nanosense.util.combat.DamageReduction
import dev.supermic.nanosense.util.combat.MotionTracker
import dev.supermic.nanosense.util.extension.fastFloor
import dev.supermic.nanosense.util.math.VectorUtils.setAndAdd
import dev.supermic.nanosense.util.math.vector.distanceSqTo
            ...
            when (event.packet) {
                ...
                is SPacketEntityMetadata -> {
                    ...
                    val entry = event.packet.dataManagerEntries.find {
                        it.isDirty && it.key == runCatching { dev.supermic.nanosense.mixins.accessor.entity.AccessorEntityLivingBase.trollGetHealthDataKey() }.getOrNull()
                    } ?: return@safeListener
