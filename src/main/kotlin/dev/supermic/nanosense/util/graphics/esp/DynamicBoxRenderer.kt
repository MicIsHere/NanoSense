package dev.supermic.nanosense.util.graphics.esp
...
import dev.supermic.nanosense.util.graphics.MatrixUtils
import dev.supermic.nanosense.util.graphics.RenderUtils3D
import dev.supermic.nanosense.util.graphics.color.ColorRGB
import dev.supermic.nanosense.util.graphics.mask.BoxOutlineMask
import dev.supermic.nanosense.util.graphics.mask.BoxVertexMask
import dev.supermic.nanosense.util.graphics.mask.SideMask
...
class DynamicBoxRenderer : AbstractIndexedRenderer() {
    ...
    object Shader : DrawShader("/assets/nanosense/shaders/general/DynamicBoxRenderer.vsh", "/assets/nanosense/shaders/general/Renderer.fsh"), AlwaysListening {
