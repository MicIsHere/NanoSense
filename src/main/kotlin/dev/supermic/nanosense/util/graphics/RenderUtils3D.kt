...
import dev.supermic.nanosense.util.accessor.renderPartialTicksPaused
...
import dev.supermic.nanosense.util.graphics.buffer.DynamicVAO
...
import dev.supermic.nanosense.util.graphics.shaders.Shader
...
object RenderUtils3D : AlwaysListening {
    ...
    private object DrawShader : Shader("/assets/nanosense/shaders/general/Pos3Color.vsh", "/assets/nanosense/shaders/general/Pos3Color.fsh")
