...
import dev.supermic.nanosense.util.graphics.fastrender.model.tileentity.ModelShulkerBox
...
class ShulkerBoxRenderBuilder(
    ...
    private companion object : Helper {
        ...
        val shader = Shader("/assets/nanosense/shaders/tileentity/ShulkerBox.vsh", "/assets/nanosense/shaders/tileentity/Default.fsh")
    }
