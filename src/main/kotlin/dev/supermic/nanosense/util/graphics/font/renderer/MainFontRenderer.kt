...
object MainFontRenderer : IFontRenderer {
    ...
    init {
        this.javaClass.getResourceAsStream("/assets/nanosense/fonts/LexendDeca-Regular.ttf").use {
    ...
    private fun loadFont(): ExtendedFontRenderer {
        val font = try {
            ...
            NanoSenseMod.logger.warn("Failed loading main font. Using Sans Serif font.", e)
