package dev.supermic.nanosense.util.graphics.font

import it.unimi.dsi.fastutil.bytes.ByteArrayList
import it.unimi.dsi.fastutil.floats.FloatArrayList
import it.unimi.dsi.fastutil.shorts.ShortArrayList
import dev.supermic.nanosense.util.graphics.GLDataType
import dev.supermic.nanosense.util.graphics.buildAttribute
import dev.supermic.nanosense.util.graphics.color.ColorRGB
import dev.supermic.nanosense.util.graphics.font.glyph.CharInfo
import dev.supermic.nanosense.util.graphics.font.glyph.GlyphChunk
import dev.supermic.nanosense.util.graphics.font.renderer.AbstractFontRenderContext
import dev.supermic.nanosense.util.graphics.font.renderer.AbstractFontRenderer
import dev.supermic.nanosense.util.graphics.shaders.DrawShader
import dev.supermic.nanosense.util.graphics.use
import dev.supermic.nanosense.util.skip
...
class RenderString(fontRenderer: AbstractFontRenderer, private val string: CharSequence) {
    ...
    private object Shader : DrawShader("/assets/nanosense/shaders/general/FontRenderer.vsh", "/assets/nanosense/shaders/general/FontRenderer.fsh") {
