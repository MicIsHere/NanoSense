...
import dev.supermic.nanosense.util.math.xCenter
import dev.supermic.nanosense.util.math.yCenter
import dev.supermic.nanosense.util.math.zCenter
...
class DynamicTracerRenderer : AbstractRenderer() {
    ...
    object Shader : DrawShader("/assets/nanosense/shaders/general/DynamicTracerRenderer.vsh", "/assets/nanosense/shaders/general/Renderer.fsh"), AlwaysListening {
