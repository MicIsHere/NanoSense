...
import dev.supermic.nanosense.util.graphics.fastrender.model.tileentity.ModelBed
...
class BedRenderBuilder(
    ...
    private companion object : Helper {
        ...
        val shader = Shader("/assets/nanosense/shaders/tileentity/Bed.vsh", "/assets/nanosense/shaders/tileentity/Default.fsh")
    }
