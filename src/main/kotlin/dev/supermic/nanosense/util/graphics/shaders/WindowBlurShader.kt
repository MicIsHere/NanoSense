package dev.supermic.nanosense.util.graphics.shaders
...
object WindowBlurShader : AlwaysListening, Helper {
    ...
    private val pass1 = Pass("/assets/nanosense/shaders/gui/WindowBlurH.vsh")
    private val pass2 = Pass("/assets/nanosense/shaders/gui/WindowBlurV.vsh")
    ...
    private open class Pass(vertShaderPath: String) : DrawShader(vertShaderPath, "/assets/nanosense/shaders/gui/WindowBlur.fsh") {
