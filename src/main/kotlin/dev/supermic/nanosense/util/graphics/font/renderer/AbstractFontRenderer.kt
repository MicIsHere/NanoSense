package dev.supermic.nanosense.util.graphics.font.renderer
...
import dev.supermic.nanosense.util.graphics.font.RenderString
import dev.supermic.nanosense.util.graphics.font.Style
import dev.supermic.nanosense.util.graphics.font.glyph.FontGlyphs
...
abstract class AbstractFontRenderer(font: Font, size: Float, private val textureSize: Int) : IFontRenderer {
    ...
    protected fun loadFont(font: Font, size: Float, style: Style): FontGlyphs {
        ...
        val fallbackFont = try {
            ...
            NanoSenseMod.logger.warn("Failed loading fallback font. Using Sans Serif font", e)
