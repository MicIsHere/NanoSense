package dev.supermic.nanosense.util.graphics.fastrender.tileentity

import dev.supermic.nanosense.util.graphics.fastrender.model.Model
import dev.supermic.nanosense.util.graphics.fastrender.model.tileentity.ModelChest
import dev.supermic.nanosense.util.graphics.fastrender.model.tileentity.ModelLargeChest
import dev.supermic.nanosense.util.graphics.texture.TextureUtils
import dev.supermic.nanosense.util.graphics.texture.TextureUtils.readImage
...
class ChestRenderBuilder(
    ...
    open class SmallChestRenderBuilder(
        ...
        protected companion object {
            ...
            val shader = Shader("/assets/nanosense/shaders/tileentity/Chest.vsh", "/assets/nanosense/shaders/tileentity/Default.fsh")
