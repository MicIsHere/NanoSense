...
import dev.supermic.nanosense.util.text.SpamFilters
...
internal object AntiSpam : Module(
    ...
    private fun sendResult(name: String, message: String) {
        ...
        if (showBlocked == ShowBlocked.LOG_FILE || showBlocked == ShowBlocked.BOTH) NanoSenseMod.logger.info("$chatName $name: $message")
    }
}
