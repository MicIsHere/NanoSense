...
import dev.supermic.nanosense.util.items.foodValue
import dev.supermic.nanosense.util.items.saturation
...
internal object HungerOverlay : Module(
    ...
    private val icons = ResourceLocation("nanosense/textures/hungeroverlay.png")
