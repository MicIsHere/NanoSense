...
import dev.supermic.nanosense.module.modules.movement.Step
...
import dev.supermic.nanosense.util.MovementUtils.resetMove
import dev.supermic.nanosense.util.PathFinder
import dev.supermic.nanosense.util.combat.HoleInfo
import dev.supermic.nanosense.util.extension.floorToInt
...
import dev.supermic.nanosense.util.world.getGroundPos
...
internal object HolePathFinder : Module(
    ...
    private fun getTargetPos(): BlockPos? {
        return (SmartCrystal.target.takeIf { SmartCrystal.isEnabled } ?: CombatManager.target)?.betterPosition
    }
