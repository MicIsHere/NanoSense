...
import dev.supermic.nanosense.gui.mc.NanoGuiDisconnected
...
import dev.supermic.nanosense.module.modules.combat.AutoLog.Reasons.*
...
internal object AutoLog : Module(
    ...
    private fun SafeClientEvent.log(reason: Reasons, additionalInfo: String = "") {
        ...
        mc.displayGuiScreen(NanoGuiDisconnected(reasonText, screen, disableMode == DisableMode.ALWAYS || (disableMode == DisableMode.NOT_PLAYER && reason != PLAYER), LocalTime.now()))
    }
