...
import dev.supermic.nanosense.util.accessor.potion
import dev.supermic.nanosense.util.combat.CombatUtils.calcDamageFromMob
import dev.supermic.nanosense.util.combat.CombatUtils.calcDamageFromPlayer
...
import dev.supermic.nanosense.util.inventory.operation.swapToItemOrMove
...
import dev.supermic.nanosense.util.items.isWeapon
...
internal object AutoOffhand : Module(
    ...
    private fun checkCrystal(): Boolean {
        return offhandCrystal && checkCACrystal
            ...
            || SmartCrystal.isActive() && CombatManager.isOnTopPriority(SmartCrystal))
    }
