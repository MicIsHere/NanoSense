...
import dev.supermic.nanosense.util.EntityUtils.spoofUnSneak
import dev.supermic.nanosense.util.TickTimer
import dev.supermic.nanosense.util.and
...
import dev.supermic.nanosense.util.inventory.executedOrTrue
import dev.supermic.nanosense.util.inventory.inventoryTask
...
import dev.supermic.nanosense.util.pause.OffhandPause
...
internal object BedAura : Module(
    ...
    private inline fun SafeClientEvent.breakBed(placeInfo: PlaceInfo) {
        ...
        player.spoofUnSneak {
            connection.sendPacket(CPacketPlayerTryUseItemOnBlock(placeInfo.bedPosFoot, side, dev.supermic.nanosense.module.modules.combat.BedAura.handMode, hitVecOffset.x, hitVecOffset.y, hitVecOffset.z))
        }
